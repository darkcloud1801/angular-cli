...
module.exports = Task.extend({
  ...
  run: function (options) {
    ...
    this.disableLogger();
    return spawn('npm', [this.command].concat(packages, npmOptions)).// return npm(this.command, packages, npmOptions, this.npm).
    finally(this.finally.bind(this)).then(this.announceCompletion.bind(this));
  },
